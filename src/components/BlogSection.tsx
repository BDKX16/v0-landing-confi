  ...
  return (
    <section className="py-16 px-4 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link to="#" className="border border-black px-4 py-2 font-fira-sans text-sm hidden sm:block rounded-lg">
          View all
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {blogPosts.map((post, index) => (
          <article key={index} className="flex flex-col">
            <Link to="#" className="block mb-4 bg-[#e0e0e0] rounded-lg overflow-hidden">
              <img
      ...
      <div className="mt-8 text-center sm:hidden">
        <Link to="#" className="border border-black px-4 py-2 font-fira-sans text-sm inline-block rounded-lg">
          View all
        </Link>
      </div>
    </section>
