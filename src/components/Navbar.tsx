...
export default function Navbar() {
  ...
  return (
    <nav className="w-full py-3 md:py-4 px-4 md:px-8 flex items-center justify-between sticky top-0 bg-white z-50 shadow-sm">
      {/* Logo */}
      <Link to="/" className="font-teachers text-xl md:text-2xl">
        Logo
      </Link>
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8">
        <Link to="#" className="font-fira-sans text-sm lg:text-base whitespace-nowrap">
          Inicio Rápido
        </Link>
        <Link to="#" className="font-fira-sans text-sm lg:text-base whitespace-nowrap">
          Nuestros Productos
        ...
        <div className="relative group">
          ...
          <div className="absolute hidden group-hover:block top-full left-0 bg-white shadow-md py-2 px-4 min-w-40 z-10 rounded-lg">
            <Link to="#" className="block py-1 font-fira-sans text-sm">
              Opción 1
            </Link>
            <Link to="#" className="block py-1 font-fira-sans text-sm">
              Opción 2
      ...
      <div className="hidden md:flex items-center gap-2 lg:gap-4">
        <Link to="#" className="font-fira-sans border border-black px-3 py-1 lg:px-4 lg:py-2 text-sm rounded-lg">
          Entrar
        </Link>
        <Link to="#" className="font-fira-sans bg-black text-white px-3 py-1 lg:px-4 lg:py-2 text-sm rounded-lg">
          Registrarse
        </Link>
      </div>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 bg-white shadow-md z-20 md:hidden rounded-b-lg">
          <div className="flex flex-col p-4">
            <Link to="#" className="py-2 font-fira-sans">
              Inicio Rápido
            </Link>
            <Link to="#" className="py-2 font-fira-sans">
              Nuestros Productos
            ...
            <div className="flex flex-col gap-2 mt-4">
              <Link to="#" className="font-fira-sans border border-black px-4 py-2 text-center rounded-lg">
                Entrar
              </Link>
              <Link to="#" className="font-fira-sans bg-black text-white px-4 py-2 text-center rounded-lg">
                Registrarse
              </Link>
            </div>
          </div>
