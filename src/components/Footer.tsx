      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          ...
          <div className="flex gap-4">
            <Link to="#" className="bg-black text-white font-fira-sans px-6 py-3 rounded-lg">
              Unirse
            </Link>
            <Link to="#" className="border border-black font-fira-sans px-6 py-3 rounded-lg">
              Contacto
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="#" className="font-fira-sans text-sm hover:underline">
                  Inicio Rápido
                </Link>
              </li>
              <li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <Link to="/" className="font-teachers text-2xl mb-6 md:mb-0">
            Logo
          </Link>
